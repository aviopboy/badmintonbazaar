...
function isValidUserBody(body: unknown): body is { id: string; name: string; email: string; password: string; admin?: boolean; joined: string } {
...
function isValidPatchBody(body: unknown): body is { admin?: boolean; name?: string; email?: string; password?: string } {
  if (!body || typeof body !== "object") return false;
...
router.patch("/users/:id", async (req, res): Promise<void> => {
  try {
    ...
    const patch = req.body as { admin?: boolean; name?: string; email?: string; password?: string };
